...
const keyControllers = {
  ...
  ArrowUp: () => {
    GameState.instance.isPlaying && GameState.instance.player.move({x:0, y:-STATICS.playerSpeed});
  },
  ArrowDown: () => {
    GameState.instance.isPlaying && GameState.instance.player.move({x:0, y:STATICS.playerSpeed});
  },
  ArrowLeft: () => {
    GameState.instance.isPlaying && GameState.instance.player.move({x:-STATICS.playerSpeed, y:0});
  },
  ArrowRight: () => {
    GameState.instance.isPlaying && GameState.instance.player.move({x:STATICS.playerSpeed, y:0});
  },
